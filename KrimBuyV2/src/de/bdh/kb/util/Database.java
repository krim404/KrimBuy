...
public class Database
{
    ...
    public void setupTable() throws Exception
    {
        ...
        if(!rs.next())
        {
	        ...
	        ps = conn.prepareStatement((new StringBuilder()).append("CREATE TABLE ").append(configManager.SQLTable).append("_krimbuy_rules(").append("`id` int(12) NOT NULL AUTO_INCREMENT,").append("`ruleset` varchar(100) NULL DEFAULT  '',").append("`level` INT(3) NULL DEFAULT  '0',").append("`giveperm` VARCHAR(255) NOT NULL DEFAULT  '',").append("`permissionnode` VARCHAR(255) NOT NULL DEFAULT  '',").append("`controlblockheight` INT(10) NULL DEFAULT  '1',").append("`autofree` INT(10) NULL DEFAULT  '0',").append("`payout` INT(1) NULL DEFAULT  '0',").append("`miet` INT(10) NULL DEFAULT  '0',").append("`cansell` INT(3) NULL DEFAULT  '70',").append("`nobuy` INT(3) NULL DEFAULT  '0',").append("`onlyamount` INT(3) NULL DEFAULT  '0',").append("`clear` INT(2) NULL DEFAULT  '1',`indoor` INT(1) NULL DEFAULT  '0',").append("`nobuild` INT(1) NULL DEFAULT  '0',").append("`height` INT(10) NULL DEFAULT  '0',").append("`deep` INT(10) NULL DEFAULT  '0', `pricexp` INT NOT NULL DEFAULT '0',`price` INT NOT NULL DEFAULT '0', `pvp` INT NOT NULL DEFAULT '0',").append("`bottom` TEXT,").append("`blocks` TEXT,").append("`gruppe` VARCHAR(25) NOT NULL DEFAULT  '',").append("PRIMARY KEY (`id`), UNIQUE KEY `rulelvl` (`level`,`ruleset`)").append(")").toString());
	        ps.executeUpdate();
